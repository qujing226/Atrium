...
*   **Implementation**: We present **Atrium**, the first post-quantum S-AKE protocol instantiating the SSC model, featuring a Proof-Carrying Resolution and an Adaptive Epoch-KEM Ratchet.
...
*   **Summary of Contributions**:
    ...
    3.  *Atrium Protocol*: A fully functional post-quantum instantiation.
...
## 4. The Atrium Protocol Design 
*   **Overview**: The architecture of S-AKE.
*   **Proof-Carrying Identity Resolution**: How Atrium remains consensus-agnostic by consuming generalized proofs.
